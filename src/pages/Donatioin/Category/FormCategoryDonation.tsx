...
import {
  ...
  insertCategory,
  updateCategory,
} from '../../../services/DonationCategoryServices';
...
const FormCategoryDonation: React.FC<{ isEdit?: boolean }> = ({ isEdit }) => {
  ...
  const insertCategoryFunc = async () => {
    ...
    try {
      ...
      setMessage('Berhasil menambahkan kategori donasi');
      setShowAlert(true);
      clearForm();
    } catch (error: any) {
      console.log(error);
      ...
      setMessage(
        error.response?.data?.errors ||
          ...
          'Gagal menambahkan kategori donasi',
      );
      setShowAlert(true);
    } finally {
      setLoading(false);
      ...
      <div className="mb-10 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="px-7 py-4">
          ...
          <div className="mb-5">
            ...
            <input
              type="text"
              placeholder="Masukkan deskripisi kategori donasi"
              value={description}
